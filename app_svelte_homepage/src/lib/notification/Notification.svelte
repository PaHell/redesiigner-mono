...
<template>
    <div class="app-nt-wrapper" class:app-visible={visible}>
        <menu class="app-nt app-nt-variant-{variant} app-nt-color-{color} animate__animated {visible ? 'animate__jackInTheBox' : 'animate__rollOut'}">
            <header>
                ...
                {/each}
                <Btn icon={variantClose[variant]?.icon}
        ...
        & > main {
            ...
            & > .app-img {
                ...
                &:after {
                    ...
                    box-shadow: inset 0 0 4px rgba(0,0,0,.3), inset 0 0 12px 1px rgba(0,0,0,.2);
                }
