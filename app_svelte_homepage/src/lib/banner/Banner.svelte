...
<template>
    <div class="app-banner app-banner-{color} animate__animated {visible ? 'animate__fadeInDown' : 'animate__fadeOutUp'}"
...
.app-banner {
    ...
    &.app-banner-undefined {
        ...
        & > .app-icon { @apply bg-gray-200 text-gray-500; }
        & > p { @apply text-gray-800; }
    }
    /* colors */
    &.app-banner-accent {
        @apply bg-accent-600 border-accent-700;
        & > .app-icon { @apply bg-accent-800 text-accent-100; }
    }
    &.app-banner-success {
        @apply bg-success-600 border-success-700;
        & > .app-icon { @apply bg-success-800 text-success-100; }
    }
    &.app-banner-warning {
        @apply bg-warning-600 border-warning-700;
        & > .app-icon { @apply bg-warning-800 text-warning-100; }
    }
    &.app-banner-danger {
        @apply bg-danger-600 border-danger-700;
        & > .app-icon { @apply bg-danger-800 text-danger-100; }
    }
    &.app-banner-info {
        @apply bg-info-600 border-info-700;
        & > .app-icon { @apply bg-info-800 text-info-100; }
    }
}
